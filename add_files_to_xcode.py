#!/usr/bin/env python3
"""
Script to add files to Xcode project.pbxproj
...
def add_files_to_pbxproj(pbxproj_path, files_to_add):
    ...
    for entry in file_entries:
        ...
        rel_path = entry['filepath'].replace('/Users/karatsidhu/Developer/WardenApp/Warden/', '')
...
if __name__ == '__main__':
    ...
    print("⚠️  IMPORTANT: Make sure to close Xcode before running this script!")
    print("⚠️  And make a backup of your project first!")
    print()
    ...
    if response.lower() == 'yes':
        ...
        if add_files_to_pbxproj(pbxproj_path, files_to_add):
            ...
            print("\n❌ Failed to add files. Backup is at:", backup_path)
            sys.exit(1)
    else:
        print("Aborted.")
